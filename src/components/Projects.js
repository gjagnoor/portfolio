                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12} sm={7}>
                      <Link to={node.frontmatter.link} target="_blank">
                        <img
                          src={images[node.frontmatter.position]}
                          className="projimg"
                        />
                      </Link>
                    </Grid>
                    ...
                    >
                      ...
                      <div>
                        <p className="projlangs">
                          {node.frontmatter.technologies}
                        </p>
                      </div>
                      <center>
                        <div
                          style={{ display: "flex", padding: "3em", margin: 0 }}
                        >
                          <div>
                            <Link
                            ...
                            >
                              <FontAwesomeIcon
                                icon={faGithubAlt}
                                size="2x"
                                style={{ margin: "0em 2em 0em 3em" }}
                              ></FontAwesomeIcon>
                            </Link>
                          </div>
                          <div>
                            <Link
                              to={node.frontmatter.link}
                              style={{
                                textDecoration: "none",
                                color: "#04d9ff",
                                cursor: "pointer",
