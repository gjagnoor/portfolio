        ...
        <List>
            {
                ['About', 'Work Experience', 'Featured Projects', 'Contact', 'Resume'].map((text, index) => (
                    <a href={ text !== "Resume" ? `/profile#${text.split(' ').join('').toLowerCase()}` : `https://drive.google.com/file/d/1ta6t3ewzs0lFxt740RxNtoS9HhtMOo11/view?usp=sharing`} style={{ textDecoration: "none", color: "inherit" }}>
                        {
