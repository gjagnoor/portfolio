    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.drawerHeader}>
          <p onClick={handleDrawerClose} style={{padding: "2em", cursor: "pointer"}}>
        ...
        <List>
            {
                ['About', 'Work Experience', 'Featured Projects', 'Contact', 'Resume'].map((text, index) => (
                    <a href={text !== "Resume" ? `/portfolio/profile/#${text.split(' ').join('').toLowerCase()}` : `https://drive.google.com/file/d/1ta6t3ewzs0lFxt740RxNtoS9HhtMOo11/view?usp=sharing`} style={{ textDecoration: "none", color: "inherit" }} target={`${text === "Resume" ? "_blank" : ""}`}>
                        {
